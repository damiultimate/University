			...
			<div class="main-content">
				...
				<section class="posts-con">
					<article>
						...
						<div class="info">
							<h3>Admission Portal opened for aspirants</h3>
							<p class="info-line"><span class="time">10:30 AM</span><span class="place">Harrison University</span></p>
							<p>Admission Portal opened for aspirants.</p>
						</div>
					</article>
					<article>
						<div class="current-date">
						...
						<div class="info">
							<h3>Admission is still in progress at Harrison University</h3>
							<p class="info-line"><span class="time">10:30 AM</span><span class="place">Lincoln High School</span></p>
							<p>Admission is still in progress at Harrison University</p>
						</div>
					</article>
					<article>
						<div class="current-date">
